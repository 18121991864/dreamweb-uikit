...
var AccountModal = function (_a) {
    ...
    return (React__default["default"].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        React__default["default"].createElement(Text, { fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" } }, isMobile ? "".concat(account.slice(0, 6), "...").concat(account.slice(36)) : account),
...
var useWalletModal = function (login, logout, account) {
    ...
    var onPresentAccountModal = useModal(React__default["default"].createElement(AccountModal, { isMobile: isMobile, account: account || "", logout: logout }))[0];
...
var UserBlock = function (_a) {
    ...
    return (React__default["default"].createElement(Userdiv, null, account ? (React__default["default"].createElement(Button, { scale: "sm", variant: "tertiary", onClick: function () {
        ...
        }, style: { backgroundColor: "#FFFFFF", color: "#030708", height: isMobile ? '42px' : '32px' } }, accountEllipsis)) : (React__default["default"].createElement(Button, { style: { height: isMobile ? '42px' : '32px' }, scale: "sm", onClick: function () {
        ...
        React__default["default"].createElement(StyledNav, { showMenu: showMenu, isLand: isLand, isMobile: isMobile },
            ...
            React__default["default"].createElement(Flex, null,
                React__default["default"].createElement(ButtonMenu$1, { scale: "sm", onItemClick: function (e) {
                    ...
                    React__default["default"].createElement(ButtonMenuItem, { as: "a", href: "".concat(swaphref, "/land/home") }, "PIXEL LAND"),
                    React__default["default"].createElement(ButtonMenuItem, { as: "a", href: "".concat(swaphref, "/home") }, "PIXEL SWAP")),
