...
import { ChevronDownIcon, ChevronUpIcon } from "../../../components/Svg";
...
const AccordionContent = styled.div<{
  ...
  border-style: solid;
  /* border-width: ${({ isOpen }) => (isOpen ? 1 : 0)}; */
  background: #112651;
`;
  ...
  return (
    <Container>
      ...
      >
        ...
        {isOpen ? (
          <ChevronUpIcon style={{ fill: "#67717A" }} />
        ) : (
          <ChevronDownIcon style={{ fill: "#67717A" }} />
        )}
      </MenuEntry>
      <AccordionContent
        isOpen={isOpen}
